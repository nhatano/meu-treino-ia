...
# --- BANCO DE DADOS DE TREINOS COMPLETO ---
TREINOS = {
    "TREINO A: LEGS A (QUADRÍCEPS)": [
        ...
        {"ex": "Abdominal Polia Média", "sets": ["1 min", "1 min", "Falha"], "bio": "Foco na contração do core.", "vid": "https://www.youtube.com/watch?v=2D7N_fU7Usc"}
    ],
    "TREINO B: PUSH A (PEITO/OMBRO)": [
        ...
        {"ex": "Voador Peck Deck", "sets": ["54kg", "61kg", "68kg (Iso 10s)"], "bio": "Esmague no centro.", "vid": "https://www.youtube.com/watch?v=Xp0NfT_SjG0"},
        ...
        {"ex": "Tríceps Francês Polia", "sets": ["15kg", "17,5kg", "20kg (Falha)"], "bio": "Cotovelos fechados.", "vid": "https://www.youtube.com/watch?v=S_mU0G0mO-E"}
    ],
    "TREINO C: PULL A (COSTAS/BÍCEPS)": [
        ...
        {"ex": "Pulldown Barra/Corda", "sets": ["30kg", "35kg", "35kg (Iso 5s)"], "bio": "Cotovelo quase travado.", "vid": "https://www.youtube.com/watch?v=8uS_w8_1I_M"},
    ...
    "TREINO D: LEGS B (POSTERIOR/GLÚTEO)": [
        ...
        {"ex": "Stiff", "sets": ["80kg", "100kg", "120kg"], "bio": "Quadril para trás. Raspe na perna.", "vid": "https://www.youtube.com/watch?v=mD2f_LueIYA"},
    ...
    "TREINO E: PUSH B (OMBROS 3D/PEITO)": [
        ...
        {"ex": "Abdominal Crunch Máquina", "sets": ["Set 1", "Set 2", "Set 3"], "bio": "Carga alta.", "vid": "https://www.youtube.com/watch?v=2D7N_fU7Usc"}
    ]
}
            ...
            with st.container():
                ...
                if st.button(f"Salvar {item['ex']}", key=f"btn_{item['ex']}_{dia}"):
                    try:
                        ...
                        st.success(f"Excelente, {u_name}! {item['ex']} registrado.")
                        st.balloons()
