...
TREINOS = {
    "TREINO A: LEGS A (QUADRÍCEPS)": [
        ...
        {"ex": "Cadeira Extensora", "sets": ["47kg", "47kg", "Drop: 54->33->19"], "bio": "Iso 2s no topo.", "vid": "https://www.youtube.com/watch?v=m0FOpMEgero"},
    ...
    "TREINO B: PUSH A (PEITO/OMBRO)": [
        ...
        {"ex": "Chest Press Articulado", "sets": ["35kg/lado", "40kg/lado", "Drop: 40->25->15"], "bio": "Altura mamilo.", "vid": "https://www.youtube.com/watch?v=l_i9I-Y8r1U"},
        ...
        {"ex": "Elevação Lateral", "sets": ["15kg", "15kg", "Drop"], "bio": "Linha do ombro.", "vid": "https://www.youtube.com/watch?v=3VkKa2kn07w"},
        {"ex": "Tríceps Corda", "sets": ["25kg", "30kg", "Drop"], "bio": "Abra embaixo.", "vid": "https://www.youtube.com/watch?v=Yid37u14vH0"},
    ...
    "TREINO C: PULL A (COSTAS/BÍCEPS)": [
        {"ex": "Puxada Alta Aberta", "sets": ["55kg", "70kg", "84,5kg"], "bio": "Use Straps.", "vid": "https://www.youtube.com/watch?v=H75im9fAUMc"},
        {"ex": "Remada Baixa Triângulo", "sets": ["84kg", "98kg", "103kg"], "bio": "1s no umbigo.", "vid": "https://www.youtube.com/watch?v=lJ7x8S_3uMA"},
        {"ex": "Remada Unilateral Polia", "sets": ["22kg", "25kg", "25kg"], "bio": "Tensão constante.", "vid": "https://www.youtube.com/watch?v=fM5K60p4S8A"},
        {"ex": "Pulldown Barra", "sets": ["30kg", "35kg", "35kg"], "bio": "Cotovelo travado.", "vid": "https://www.youtube.com/watch?v=8uS_w8_1I_M"},
    ...
    "TREINO D: LEGS B (POSTERIOR/GLÚTEO)": [
        {"ex": "Cadeira Flexora", "sets": ["54kg", "61kg", "68kg"], "bio": "Tronco inclinado.", "vid": "https://www.youtube.com/watch?v=78V9XpS7F7M"},
        {"ex": "Stiff", "sets": ["80kg", "100kg", "120kg"], "bio": "Quadril para trás.", "vid": "https://www.youtube.com/watch?v=mD2f_LueIYA"},
        {"ex": "Leg Press (Pés no Topo)", "sets": ["200kg", "240kg", "260kg"], "bio": "Empurre pelo calcanhar.", "vid": "https://www.youtube.com/watch?v=yZmx_7igYyU"},
        {"ex": "Elevação Pélvica", "sets": ["110kg", "130kg", "150kg"], "bio": "Iso 3s topo.", "vid": "https://www.youtube.com/watch?v=A8nFGuY77CE"},
    ...
    "TREINO E: PUSH B (OMBROS 3D/PEITO)": [
        {"ex": "Desenv. Halteres", "sets": ["20kg", "24kg", "30kg"], "bio": "Banco 80º.", "vid": "https://www.youtube.com/watch?v=HzIiIn92_2M"},
        {"ex": "Elevação Lateral Polia", "sets": ["7,5kg", "10kg", "12kg"], "bio": "Por trás do corpo.", "vid": "https://www.youtube.com/watch?v=3VkKa2kn07w"},
        {"ex": "Supino Inc. Articulado", "sets": ["25kg/l", "35kg/l", "40kg/l"], "bio": "Foco superior.", "vid": "https://www.youtube.com/watch?v=5E6V_uT2yS8"},
...
with st.sidebar:
    ...
    # O SELETOR DE TREINOS AGORA ESTÁ AQUI NA SIDEBAR
...
if user_email in [MEU_EMAIL, SAYRA_EMAIL]:
    ...
    # MOSTRAR EXERCÍCIOS DO DIA SELECIONADO NA SIDEBAR
    for item in TREINOS[dia]:
        with st.container():
            ...
            with cv:
                # Tenta carregar o vídeo, se falhar mostra um aviso amigável
                try:
                    st.video(item['vid'])
                except:
                    st.warning("Vídeo em manutenção")
            with cd:
