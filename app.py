...
# --- BANCO DE DADOS DE TREINOS (TODOS OS DIAS E VÍDEOS REVISADOS) ---
TREINOS = {
    "TREINO 1: LEGS A (QUADRÍCEPS)": [
        ...
        {"ex": "Panturrilha no Leg", "sets": ["150kg (15 reps)", "150kg", "150kg (Falha)"], "bio": "Alongamento máximo.", "vid": "https://www.youtube.com/watch?v=q_K2eW7mUqI"},
        {"ex": "Abdominal Polia", "sets": ["Set 1", "Set 2", "Set 3"], "bio": "Foco na contração.", "vid": "https://www.youtube.com/watch?v=2D7N_fU7Usc"}
    ],
    "TREINO 2: PUSH A (PEITO/OMBRO)": [
        {"ex": "Supino Inclinado Halteres", "sets": ["25kg (15 reps)", "27,5kg (12 reps)", "30kg (10 reps)", "32,5kg (6 reps)"], "bio": "Banco 30º. Escápulas retraídas.", "vid": "https://www.youtube.com/watch?v=8iP9S706yLw"},
        ...
        {"ex": "Desenv. Máquina", "sets": ["25kg/lado", "30kg/lado", "35kg/lado"], "bio": "Punho alinhado.", "vid": "https://www.youtube.com/watch?v=WvLMauqrnK8"},
        {"ex": "Voador Peck Deck", "sets": ["54kg", "61kg", "68kg"], "bio": "Esmague no centro.", "vid": "https://www.youtube.com/watch?v=Xp0NfT_SjG0"},
        {"ex": "Elevação Lateral", "sets": ["15kg", "15kg", "Drop: 16->10->6"], "bio": "Linha do ombro.", "vid": "https://www.youtube.com/watch?v=3VkKa2kn07w"},
        {"ex": "Tríceps Corda", "sets": ["25kg", "30kg", "Drop: 32,5->22,5->15"], "bio": "Abra embaixo.", "vid": "https://www.youtube.com/watch?v=Yid37u14vH0"},
    ...
    "TREINO 3: PULL A (COSTAS/BÍCEPS)": [
        {"ex": "Puxada Alta Aberta", "sets": ["55kg", "70kg", "77,5kg", "84,5kg"], "bio": "Use STRAPS. Cotovelo guia.", "vid": "https://www.youtube.com/watch?v=H75im9fAUMc"},
        {"ex": "Remada Baixa Triângulo", "sets": ["84,5kg", "98,3kg", "103kg"], "bio": "Segure 1s no umbigo.", "vid": "https://www.youtube.com/watch?v=lJ7x8S_3uMA"},
        {"ex": "Remada Unilateral Polia", "sets": ["22,5kg", "25kg", "25kg"], "bio": "Tensão constante.", "vid": "https://www.youtube.com/watch?v=fM5K60p4S8A"},
        {"ex": "Pulldown Barra/Corda", "sets": ["30kg", "35kg", "35kg"], "bio": "Cotovelo quase travado.", "vid": "https://www.youtube.com/watch?v=8uS_w8_1I_M"},
        {"ex": "Crucifixo Inverso Máquina", "sets": ["33kg", "40kg", "40kg"], "bio": "Deltoide posterior.", "vid": "https://www.youtube.com/watch?v=Xp0NfT_SjG0"},
        {"ex": "Rosca Martelo", "sets": ["15kg", "16kg", "18kg"], "bio": "Bíceps braquial.", "vid": "https://www.youtube.com/watch?v=zS9_3mE9L6o"},
    ...
    "TREINO 4: LEGS B (POSTERIOR/GLÚTEO)": [
        {"ex": "Cadeira Flexora", "sets": ["54kg", "61kg", "68kg", "Drop 75kg"], "bio": "Tronco inclinado.", "vid": "https://www.youtube.com/watch?v=78V9XpS7F7M"},
        ...
        {"ex": "Elevação Pernas (Infra)", "sets": ["Set 1", "Set 2", "Set 3"], "bio": "Core ativado.", "vid": "https://www.youtube.com/watch?v=Pr1ieGZ5atk"}
    ],
    "TREINO 5: PUSH B (OMBROS 3D/PEITO)": [
        ...
        {"ex": "Elevação Lateral Polia", "sets": ["7,5kg", "7,5kg", "10kg"], "bio": "Por trás do corpo.", "vid": "https://www.youtube.com/watch?v=3VkKa2kn07w"},
        {"ex": "Supino Inclinado Articulado", "sets": ["25kg/l", "35kg/l", "40kg/l"], "bio": "Foco peito superior.", "vid": "https://www.youtube.com/watch?v=5E6V_uT2yS8"},
        {"ex": "Tríceps Pulley Reta", "sets": ["25kg", "30kg", "Drop: 35->20->10"], "bio": "Punho firme.", "vid": "https://www.youtube.com/watch?v=2-LAMcpz_OQ"},
        {"ex": "Elevação Frontal Anilha", "sets": ["12,5kg", "15kg", "15kg"], "bio": "Até linha dos olhos.", "vid": "https://www.youtube.com/watch?v=xS9v3_S1XnE"},
...
if btn_login or user_email:
    if user_email in [MEU_EMAIL, SAYRA_EMAIL]:
        ...
        tab1, tab2 = st.tabs(["TREINOS", "COACH IA"])
                ...
                with st.container():
                    ...
                    with cd:
                        for i, meta in enumerate(item['sets']):
                            ...
                            cols[1].number_input("Peso (kg)", key=f"w_{item['ex']}_{i}_{dia}", min_value=0)
                            cols[2].selectbox("RPE", list(range(1,11)), index=7, key=f"r_{item['ex']}_{i}_{dia}")
                    ...
                    if st.button(f"Salvar {item['ex']}", key=f"btn_{item['ex']}_{dia}"):
                        try:
                            df_save = pd.DataFrame([{
                                ...
                                "Exercicio": item['ex'],
                                "Serie": i + 1,
                                "Alvo": st.session_state[f"t_{item['ex']}_{i}_{dia}"],
                                "Carga": st.session_state[f"w_{item['ex']}_{i}_{dia}"],
                                "RPE": st.session_state[f"r_{item['ex']}_{i}_{dia}"]
                            } for i in range(len(item['sets']))])
                            
                            conn.create(worksheet="Historico", data=df_save)
        ...
        with tab2:
            ...
            duvida = st.text_area("Sua dúvida técnica:")
            if st.button("Consultar"):
                resp = model.generate_content(f"Nilson treina pesado. {duvida}")
                st.info(resp.text)
else:
